      ...
      <div class="bg-pic">
        ...
        <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
          ...
          <h2 class="semi-bold text-white">
					...
					Seja bem vindo ao GestorCar revolução web da gestão de veículos</h2>

          <p class="small">

            As imagens utilizadas aqui são meramente ilustrativas. 2014 -2015 GestorCar
      ...
      <div class="login-container bg-white">
        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <div class="logo">
          	...
          	<img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo.png" width="233" height="87">
          ...
          <form id="form-login" class="p-t-15" role="form" action="index.html">
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                ...
                <?php  echo form_input('login', '', 'class="form-control" placeholder="E-mail"'); ?>
            ...
            <div class="col-md-14 text-right">
              ...
              <a class="text-info small" href="http://www.gestorcar.com.br/contato" target="_blank">Entre em contato!</a>

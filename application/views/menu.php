<?php
	//Defini o usuário da sessão
	$usuario = $this->session->userdata('usuario');
	//Busca a empresa relacionada
        ...
        <div class=" pull-right">
          ...
          <div class="visible-lg visible-md m-t-10">
            <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
              Seja Bem Vindo: <?php echo $usuario; echo " | "; echo $empresa;  echo " | "; echo anchor('home/logout','Sair', 'title = "Efetuar Logout"'); ?>
            </div>
